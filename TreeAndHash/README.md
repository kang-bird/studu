...
* Implementation of in-memory key-value store based on a hash table (implemented by [ExpectoPatronus](https://github.com/ExpectoPatronus))
* Implementation of in-memory key-value store based on self-balancing binary search tree
* Implementation of the console interface (implemented by [ExpectoPatronus](https://github.com/ExpectoPatronus))
* Research on temporal characteristics work of hash table and self-balancing binary search tree (implemented [ExpectoPatronus](https://github.com/ExpectoPatronus))
